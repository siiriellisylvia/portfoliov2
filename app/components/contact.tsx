        ...
        <div className="flex flex-row justify-evenly w-full md:w-1/2">
          <div className="flex flex-col items-center w-1/4 px-2">
            <Link to="mailto:siiri.lietu@gmail.com">
              <Icon
                name="email"
                className="h-16 w-16 md:w-24 md:h-24 fill-primary-pink bg-primary-green p-2 rounded"
                hideLabel={true}
              />
            </Link>
            <p className="text-[8pt]! md:text-sm! mt-2">
          ...
          <div className="flex flex-col items-center w-1/4 px-2">
            <Icon
              ...
              hideLabel={true}
            />
            <p className="text-[8pt]! md:text-sm! mt-2">42464737</p>
          </div>
          <div className="flex flex-col items-center w-1/4 px-2">
            <Link to="https://www.linkedin.com/in/siiri-lietu-b3375387/">
              <Icon
                name="linkedin"
                className="h-16 w-16 md:w-24 md:h-24 fill-primary-green bg-primary-green p-2 rounded"
                hideLabel={true}
              />
            </Link>
            <p className="text-[8pt]! md:text-sm! mt-2">LinkedIn</p>
          </div>
          <div className="flex flex-col items-center w-1/4 px-2">
            ...
            <p className="text-[8pt]! md:text-sm! mt-2">Github</p>
          </div>
        </div>
      </section>
    </>
